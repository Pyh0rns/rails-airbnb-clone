...
Studio.destroy_all
puts "create studios"
Studio.create!(address: "lille", title: "Crazy Metal Studio", description: "Premium studio
...
Studio.create!(address: "kingston", title: "Reggae Master Studio", description: "We provide top of
