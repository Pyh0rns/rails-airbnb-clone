...
Booking.create!(studio_id: studio2.id, user_id: py.id, start_date: '2022-04-28', end_date: '2022-04-29', comment: "Could you please get a couple beers in the fridge before we arrive? Thanks" )
...
Booking.create!(studio_id: studio4.id, user_id: marin.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
...
Booking.create!(studio_id: studio7.id, user_id: py.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio8.id, user_id: felix.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
...
Booking.create!(studio_id: studio8.id, user_id: manu.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
...
Booking.create!(studio_id: studio9.id, user_id: manu.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
