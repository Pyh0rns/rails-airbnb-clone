...
studio2 = Studio.create!(address: "2 avenue des saules, lille", title: "Small but Cozy Studio", description: "Artist
...
studio3 = Studio.create!(address: "17 rue de la butte aux cailles, Paris", title: "The Dandy Studio", description: "Through meticulous
...
studio4 = Studio.create!(address: "12 avenue des Champs Elysées, paris", title: "The Great Place Studio", description: "Intimate studio
...
studio5 = Studio.create!(address: "rue du chateau, brest", title: "Reggae Master Studio", description: "We provide top of
...
studio6 = Studio.create!(address: "Anvers", title: "Belgian Sound Machine", description: "We provide top of
  the line equipment at some of the most affordable prices. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", price: 80,
  user_id: py.id, photo_url: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8YmVsZ2lhbiUyMG11c2ljfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60")
studio7 = Studio.create!(address: "Oxford Circus, London", title: "Flabbergasted", description: "We provide top of
  the line equipment at some of the most affordable prices. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", price: 80,
  user_id: manu.id, photo_url: "https://images.unsplash.com/photo-1574518205159-3d19b27994bb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fGxvbmRvbiUyMHN0dWRpbyUyMG11c2ljfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60")
studio8 = Studio.create!(address: "Mumbai", title: "The Bollywood Studio", description: "We provide top of
  the line equipment at some of the most affordable prices. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", price: 80,
  user_id: py.id, photo_url: "https://images.unsplash.com/photo-1510765355166-88d0a7dd8d6c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fGluZGlhfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60")
studio9 = Studio.create!(address: "Marne la coquette", title: "Groovy Baby Studio", description: "We provide top of
  the line equipment at some of the most affordable prices. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", price: 80,
  user_id: felix.id, photo_url: "https://images.unsplash.com/photo-1470019693664-1d202d2c0907?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8Z3Jvb3ZlJTIwc3R1ZGlvJTIwbXVzaWN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60")
...
Booking.create!(studio_id: studio2.id, user_id: py.id, start_date: '2022-04-25', end_date: '2022-04-26', comment: "Could you please get a couple beers in the fridge before we arrive? Thanks" )
...
Booking.create!(studio_id: studio2.id, user_id: manu.id, start_date: '2022-07-27', end_date: '2022-07-29', comment: "We will arrive very early, around 06:00." )
...
Booking.create!(studio_id: studio4.id, user_id: felix.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio4.id, user_id: marin.id, start_date: '2022-04-10', end_date: '2022-05-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio5.id, user_id: felix.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio7.id, user_id: marin.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio7.id, user_id: py.id, start_date: '2022-04-10', end_date: '2022-05-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio8.id, user_id: felix.id, start_date: '2022-01-10', end_date: '2022-02-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio8.id, user_id: marin.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio8.id, user_id: manu.id, start_date: '2022-04-10', end_date: '2022-05-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio9.id, user_id: py.id, start_date: '2022-03-10', end_date: '2022-03-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
Booking.create!(studio_id: studio9.id, user_id: manu.id, start_date: '2022-04-10', end_date: '2022-05-11', comment: "Can you please get a parking spot for us, we have a big tour bus. Cheers" )
